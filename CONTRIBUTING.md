...
You're always welcome to submit your PR straight away and start the discussion (without reading the rest of this wonderful doc, or the [`README.md`](README.md)). The goal of these notes is to make your experience contributing to fs2-rabbit as smooth and pleasant as possible. We're happy to guide you through the process once you've submitted your PR.
...
In case of any questions, don't hesitate to ask on our [gitter channel](https://gitter.im/fs2-rabbit/fs2-rabbit).
